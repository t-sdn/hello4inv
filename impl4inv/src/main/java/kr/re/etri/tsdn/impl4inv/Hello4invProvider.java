 ...
 */
package kr.re.etri.tsdn.impl4inv;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.hello.impl4inv.rev141210.Hello4invRuntimeMXBean;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.hello.impl4inv.rev141210.HelloImpl4invService;
...
public class Hello4invProvider implements BindingAwareProvider, AutoCloseable, Hello4invRuntimeMXBean {
	...
	public void updateSbNode(String id) {
		...
		LOG.info("hello4inv jmx updateSbNode called");
	}
